package network.palace.parkmanager.designstation;
...
public class DesignStation {
    ...
    public static TestTrackVehicle getPlayerVehicle(UUID uuid) {
        playerVehicles.computeIfAbsent(uuid, k -> new TestTrackVehicle());
    ...
    public static void showStats(Player player) {
        ...
        String tooltip = ChatColor.BLUE + "Design Score\n" + ChatColor.AQUA + "Final Score: " + score;
