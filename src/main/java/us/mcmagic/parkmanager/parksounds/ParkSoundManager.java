package us.mcmagic.parkmanager.parksounds;
...
public class ParkSoundManager {
    ...
    public ParkSoundManager() {
        ParkManager.getInstance().getLogger().info("ParkSoundManager Initialized.");
    ...
    public void initialize() {
        ...
        ParkManager.getInstance().getLogger().info("(ParkTimerManager) Loaded " + sounds.size() + " timers!");
    }
