...
public class Commandautograph implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
            ...
            if (args.length == 2) {
                if (args[0].equalsIgnoreCase("remove")) {
                    ...
                    try {
                        ...
                        MagicAssistant.autographManager.removeAutograph(player, pageNum);
                        return true;
        ...
        switch (args[0].toLowerCase()) {
            case "accept":
                MagicAssistant.autographManager.acceptRequest(player);
                return true;
            case "deny":
                MagicAssistant.autographManager.denyRequest(player);
                return true;
        }
        ...
        MagicAssistant.autographManager.requestToSign(player, tp);
        return true;
    }
