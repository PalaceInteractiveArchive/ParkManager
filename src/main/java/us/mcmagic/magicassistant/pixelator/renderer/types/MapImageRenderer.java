package us.mcmagic.magicassistant.pixelator.renderer.types;

import org.bukkit.entity.Player;
import us.mcmagic.magicassistant.MagicAssistant;
import us.mcmagic.magicassistant.pixelator.renderer.ImageRenderer;
import us.mcmagic.magicassistant.pixelator.renderer.SourceType;
import us.mcmagic.magicassistant.pixelator.renderer.util.ImageUtil;
import us.mcmagic.magicassistant.pixelator.util.FilesystemCache;
...
public class MapImageRenderer extends ImageRenderer {
    ...
    public MapImageRenderer(MagicAssistant plugin, short id, final String imageSource, final SourceType imageSourceType) throws Exception {
        super(id, null);
    ...
    public MapImageRenderer(MagicAssistant plugin, String imageSource, SourceType imageSourceType) throws Exception {
        this(plugin, generateMapId(), imageSource, imageSourceType);
    }

    private MapImageRenderer(final MagicAssistant plugin, short id, final short frameId, final String imageSource, final SourceType imageSourceType) throws Exception {
        super(id, null);
        this.imageSource = imageSource;
        this.imageSourceType = imageSourceType;
        loadNew();
    ...
    public static MapImageRenderer load(short id, String type) throws Exception {
        return new MapImageRenderer(MagicAssistant.getInstance(), id, type, SourceType.URL);
    }

    public static MapImageRenderer fromString(MagicAssistant plugin, String s) throws Exception {
        String[] e = s.split("@");
