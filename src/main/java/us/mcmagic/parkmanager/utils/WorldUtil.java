...
public class WorldUtil {
    ...
    public static Chunk strToChunk(String string) {
        try {
            ...
            return getWorld(tokens[0]).getChunkAt(Integer.parseInt(tokens[1]),
    ...
    public static String locToStr(Location loc) {
        ...
        return loc.getWorld().getName() + "," + MathUtil.trim(1, loc.getX())
                + "," + MathUtil.trim(1, loc.getY()) + ","
                + MathUtil.trim(1, loc.getZ());
    }
