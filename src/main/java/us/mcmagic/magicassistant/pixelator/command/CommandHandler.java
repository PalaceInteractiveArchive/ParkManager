...
public abstract class CommandHandler implements CommandExecutor, Iterable {
    ...
    public CommandHandler(MagicAssistant plugin, String command, String helpHeader, String helpFooter, String helpCommandLabel, int helpCommandsPerPage, String... masterPermissions) {
        this.plugin = plugin;
