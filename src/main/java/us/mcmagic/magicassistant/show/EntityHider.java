...
public class EntityHider implements Listener {
    ...
    private static final Integer[] ENTITY_PACKETS = {Packets.Server.ENTITY_EQUIPMENT, Packets.Server.ENTITY_LOCATION_ACTION,
            Packets.Server.ARM_ANIMATION, Packets.Server.NAMED_ENTITY_SPAWN, Packets.Server.COLLECT,
            Packets.Server.VEHICLE_SPAWN, Packets.Server.MOB_SPAWN, Packets.Server.ENTITY_PAINTING,
            Packets.Server.ADD_EXP_ORB, Packets.Server.ENTITY_VELOCITY, Packets.Server.REL_ENTITY_MOVE,
            Packets.Server.ENTITY_LOOK, Packets.Server.REL_ENTITY_MOVE_LOOK, Packets.Server.REL_ENTITY_MOVE_LOOK,
            Packets.Server.ENTITY_TELEPORT, Packets.Server.ENTITY_HEAD_ROTATION, Packets.Server.ENTITY_STATUS,
            Packets.Server.ATTACH_ENTITY, Packets.Server.ENTITY_METADATA, Packets.Server.MOB_EFFECT,
            Packets.Server.REMOVE_MOB_EFFECT, Packets.Server.BLOCK_BREAK_ANIMATION
    };
    ...
    public final boolean hideEntity(Player observer, Entity entity) {
        ...
        if (visibleBefore) {
            PacketContainer destroyEntity = new PacketContainer(Packets.Server.DESTROY_ENTITY);
