...
public enum BandType {
    RED(true, ChatColor.RED + "Red"), ORANGE(true, ChatColor.GOLD + "Orange"),
    YELLOW(true, ChatColor.YELLOW + "Yellow"), GREEN(true, ChatColor.DARK_GREEN + "Green"),
    BLUE(true, ChatColor.BLUE + "Blue"), PURPLE(true, ChatColor.DARK_PURPLE + "Purple"),
