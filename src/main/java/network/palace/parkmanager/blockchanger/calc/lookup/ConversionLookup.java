package network.palace.parkmanager.blockchanger.calc.lookup;
...
public interface ConversionLookup {
     ...
     */
    void setBlockLookup(int blockID, int newBlockID);
     ...
     */
    int getBlockLookup(int blockID);
     ...
     */
    void setDataLookup(int blockID, int originalDataValue, int newDataValue);
     ...
     */
    int getDataLookup(int blockID, int dataValue);
