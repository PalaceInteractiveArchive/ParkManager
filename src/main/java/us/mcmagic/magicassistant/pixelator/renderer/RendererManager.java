package us.mcmagic.magicassistant.pixelator.renderer;
...
import us.mcmagic.magicassistant.pixelator.manager.Manager;
import us.mcmagic.magicassistant.pixelator.reader.CompressedStringReader;
import us.mcmagic.magicassistant.pixelator.renderer.types.MapImageRenderer;
import us.mcmagic.magicassistant.pixelator.renderer.util.RendererList;
...
public class RendererManager extends Manager {
    ...
    public RendererManager(MagicAssistant plugin) {
        super(plugin);
        this.initialize();
    }
